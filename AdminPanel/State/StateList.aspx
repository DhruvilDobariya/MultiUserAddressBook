<%@ Page Title="" Language="C#" MasterPageFile="~/Content/AddressBook.Master" AutoEventWireup="true" CodeBehind="StateList.aspx.cs" Inherits="MultiUserAddressBook.AdminPanel.State.StateList" %>
        ...
        <asp:GridView ID="gvState" runat="server" CssClass="" AutoGenerateColumns="false" OnRowCommand="gvState_RowCommand">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Edit">
                    <ItemTemplate>
                        <asp:HyperLink runat="server" ID="hyEdit" NavigateUrl='<%# "~/AdminPanel/State/StateAddEdit.aspx?StateID=" + Eval("StateID").ToString().Trim() %>' CssClass="btn btn-gradient">
                 ...
                 <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" ID="btnDelete" CssClass="btn btn-danger" CommandName="DeleteRecord" CommandArgument='<%# Eval("StateID").ToString() %>'>
